...
export default function App() {
  ...
  return <main className="app-shell">
    ...
    <div className={`app-signature ${(selectedPOI||showChat||showTour||showExplore||showCamera)?'panel-open':''}`}><span>Smart AI Travel by Franklim Herwing</span><span>v0.12.2</span></div>
